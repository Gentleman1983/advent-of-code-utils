...
class AoC2023Day16TheFloorWillBeLava(private var filename: String) {
    fun solvePart1(): Long =
    ...
    private fun getEnergy(
        contraption: List<List<AoC2023Day16Tile>>,
    ...
    private fun traceBeam(contraption: List<List<AoC2023Day16Tile>>, enteredDirection: GeoDirection, startTile: AoC2023Day16Tile) {
    ...
    private fun parseTiles(input: List<String>) =
        input
            .mapIndexed { row, line ->
                line
                    .mapIndexed { column, c ->
                        AoC2023Day16Tile(Position2d(column, row), c)
                    }
            }
