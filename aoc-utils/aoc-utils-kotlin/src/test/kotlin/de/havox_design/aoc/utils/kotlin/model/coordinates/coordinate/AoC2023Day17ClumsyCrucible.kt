...
class AoC2023Day17ClumsyCrucible(private var filename: String) {
    fun solvePart1(): Long =
        parseCoordinateMap()
            .findPath()
    ...
    private fun Map<Coordinate, Int>.findPath(
        ...
        val queue = priorityQueueOf(
            ...
            AoC2023Day17History(FourDirectionsFlipped.RIGHT, origin, 0) to 0L
        )
        val visited = mutableMapOf<AoC2023Day17History, Long>()
