...
data class AoC2023Day05Almanac(val seeds: List<Long>, val maps: List<List<Position3d<Long>>>) {
    ...
    companion object {
        fun from(input: List<String>): AoC2023Day05Almanac {
            ...
            return AoC2023Day05Almanac(seeds, maps)
        }
    }
}
