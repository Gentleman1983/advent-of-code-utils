...
enum class AoC2023Day07GameType(private var order: Int) {
    FIVE_OF_A_KIND(6),
    FOUR_OF_A_KIND(5),
    FULL_HOUSE(4),
    THREE_OF_A_KIND(3),
    ...
    companion object {
        fun from(hand: AoC2023Day07Hand, isPartOne: Boolean): AoC2023Day07GameType {
            if (isPartOne) {
        ...
        fun compare(a: AoC2023Day07GameType, b: AoC2023Day07GameType): Int =
            a
                .order
                .compareTo(b.order)

        private fun fromPartOne(hand: AoC2023Day07Hand): AoC2023Day07GameType {
        ...
        private fun fromPartTwo(hand: AoC2023Day07Hand): AoC2023Day07GameType {
        ...
        private fun getCardMap(hand: AoC2023Day07Hand): Map<Card, Int> {
        ...
        private fun getNumberOfJokers(hand: AoC2023Day07Hand): Int {
