...
class AoC2022Day17Test {
    ...
    fun testRocks(rock: AoC2022Day17Rock, expectedWidth: Long, expectedHeigth: Long, expectedBlockedElements: Set<Position2d<Long>>) =
        assertAll(
    ...
    fun testJets(code: String, expectedJet: AoC2022Day17Jet) =
        AoC2022Day17Jet.getJetForCode(code).shouldBe(expectedJet)

    @ParameterizedTest
    @MethodSource("getDataForTestReadData")
    fun testReadData(filename: String, expectedJets: List<AoC2022Day17Jet>) =
    ...
    fun testRockSpawning(expectedPosition: Position2d<Long>) =
        AoC2022Day17Chamber().getStartPositionForRock().shouldBe(expectedPosition)
    ...
    companion object {
        ...
        private fun getDataForTestRocks(): Stream<Arguments> =
            Stream.of(
                Arguments.of(AoC2022Day17Rock.ARROW, 3, 3, getBlockedFieldsForString("..#\n..#\n###")),
                Arguments.of(AoC2022Day17Rock.BOX, 2, 2, getBlockedFieldsForString("##\n##")),
                Arguments.of(AoC2022Day17Rock.HORIZONTAL_LINE, 4, 1, getBlockedFieldsForString("####")),
                Arguments.of(AoC2022Day17Rock.PLUS, 3, 3, getBlockedFieldsForString(".#.\n###\n.#.")),
                Arguments.of(AoC2022Day17Rock.VERTICAL_LINE, 1, 4, getBlockedFieldsForString("#\n#\n#\n#"))
            )

        @JvmStatic
        private fun getDataForTestJets(): Stream<Arguments> =
            Stream.of(
                Arguments.of("<", AoC2022Day17Jet.LEFT),
                Arguments.of(">", AoC2022Day17Jet.RIGHT),
                Arguments.of("v", AoC2022Day17Jet.DOWN),
                Arguments.of("foo", AoC2022Day17Jet.UNKNOWN),
                Arguments.of("bar", AoC2022Day17Jet.UNKNOWN),
                Arguments.of(".", AoC2022Day17Jet.UNKNOWN)
            )
        ...
        private fun toJetList(data: String): List<AoC2022Day17Jet> {
            val jets = emptyList<AoC2022Day17Jet>().toMutableList()

            for (index in data.indices) {
                jets += AoC2022Day17Jet.getJetForCode(data.substring(index, index + 1))
            }
