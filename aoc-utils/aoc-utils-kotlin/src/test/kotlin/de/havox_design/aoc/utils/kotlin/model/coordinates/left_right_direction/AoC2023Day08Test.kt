...
class AoC2023Day08Test {
    @ParameterizedTest
    @MethodSource("getDataForTestSolvePart1")
    fun testSolvePart1(filename: String, expectedResult: Long) =
        AoC2023Day08HauntedWasteland(filename).solvePart1().shouldBe(expectedResult)

    @ParameterizedTest
    @MethodSource("getDataForTestSolvePart2")
    fun testSolvePart2(filename: String, expectedResult: Long) =
        AoC2023Day08HauntedWasteland(filename).solvePart2().shouldBe(expectedResult)
