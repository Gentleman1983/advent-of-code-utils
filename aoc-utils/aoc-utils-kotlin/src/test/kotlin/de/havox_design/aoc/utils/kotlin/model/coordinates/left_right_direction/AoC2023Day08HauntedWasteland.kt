...
class AoC2023Day08HauntedWasteland(private var filename: String) {
    ...
    private val NODES = HashSet<AoC2023Day08Node>()
    ...
    private fun findLoop(start: AoC2023Day08Node, endNodeSuffix: String): Int {
        var index = 0
        var current = start
        var steps = 0
    ...
    private fun parseNodes(input: List<String>) {
        ...
        for (index in input.indices) {
            ...
            NODES.add(AoC2023Day08Node(nodeName, null, null))
        }
