...
data class AoC2023Day18DigInstruction(val direction: FourDirectionsFlipped, val amount: Int, val colorCode: String) {
    fun transformInstruction(): AoC2023Day18DigInstruction {
