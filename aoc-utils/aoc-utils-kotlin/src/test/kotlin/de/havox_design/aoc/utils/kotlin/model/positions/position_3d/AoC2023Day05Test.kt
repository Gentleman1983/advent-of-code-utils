...
class AoC2023Day05Test {
    @ParameterizedTest
    @MethodSource("getDataForTestSolvePart1")
    fun testSolvePart1(filename: String, expectedResult: Long) =
        AoC2023Day05IfYouGiveASeedAFertilizer(filename).solvePart1().shouldBe(expectedResult)

    @ParameterizedTest
    @MethodSource("getDataForTestSolvePart2")
    fun testSolvePart2(filename: String, expectedResult: Long) =
        AoC2023Day05IfYouGiveASeedAFertilizer(filename).solvePart2().shouldBe(expectedResult)
