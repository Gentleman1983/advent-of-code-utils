...
class AoC2015Day18Test {

    @ParameterizedTest
    @MethodSource("getDataForTestProcessPart1")
    fun testProcessPart1(filename: String, expectedResult: Int, steps: Int) =
        AoC2015Day18GIFMatrix(filename).processPart1(steps).shouldBe(expectedResult)

    @ParameterizedTest
    @MethodSource("getDataForTestProcessPart2")
    fun testProcessPart2(filename: String, expectedResult: Int, steps: Int) =
        AoC2015Day18GIFMatrix(filename).processPart2(steps).shouldBe(expectedResult)
