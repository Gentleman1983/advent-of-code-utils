...
class AoC2024Day16ReindeerMaze(private var filename: String) {
    ...
    private fun findLowestScore(
        ...
        val queue = PriorityQueue<AoC2024Day16State>(compareBy { it.score })
        ...
        while (queue.isNotEmpty()) {
            ...
            queue
                .add(AoC2024Day16State(pos, dir.rotateRight(), score + 1000, path))
            queue
                .add(AoC2024Day16State(pos, dir.rotateLeft(), score + 1000, path))
