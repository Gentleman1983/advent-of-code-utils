...
public class AoC2019Day13CarePackage implements AoCFunctionality {
    ...
    public AoC2019Day13CarePackage(String fileName) {
        input = Arrays
    ...
    public static long processTask1(String fileName) {
        AoC2019Day13CarePackage instance = new AoC2019Day13CarePackage(fileName);
