...
public class AoC2017Day18Duet implements AoCFunctionality {
    private final List<Instruction> program1;
    private final List<Instruction> program2;

    public AoC2017Day18Duet(String fileName) {
    ...
    public static BigInteger solvePart1(String fileName) {
        AoC2017Day18Duet instance = new AoC2017Day18Duet(fileName);
