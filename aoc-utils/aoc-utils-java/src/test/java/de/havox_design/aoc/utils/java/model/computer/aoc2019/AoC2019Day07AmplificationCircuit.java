...
public class AoC2019Day07AmplificationCircuit implements AoCFunctionality {
    private static final String VALUE_DELIMITER = ",";

    private final List<Long> input;

    public AoC2019Day07AmplificationCircuit(String fileName) {
        input = Arrays
    ...
    public static long processTask1(String fileName) {
        AoC2019Day07AmplificationCircuit instance = new AoC2019Day07AmplificationCircuit(fileName);
