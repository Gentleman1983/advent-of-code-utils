...
class AoC2015Day12JSONAbacusTest {

    @ParameterizedTest
    @MethodSource("getDataForPart1")
    void testPart1(String fileName, int expectedSum) {
        Assertions.assertEquals(expectedSum, AoC2015Day12JSONAbacus.solvePart1(fileName));
    }
    ...
    void testPart2(String fileName, int expectedSum) {
        Assertions.assertEquals(expectedSum, AoC2015Day12JSONAbacus.solvePart2(fileName));
    }
