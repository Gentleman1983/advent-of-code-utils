...
class AoC2018Day15Test {

    @ParameterizedTest
    @MethodSource("getDataForTask1")
    void testTask1(String fileName, int expectation) {
        Assertions.assertEquals(expectation, AoC2018Day15BeverageBandits.processTask1(fileName));
    }
    ...
    void testTask2(String fileName, int expectation) {
        Assertions.assertEquals(expectation, AoC2018Day15BeverageBandits.processTask2(fileName));
    }
