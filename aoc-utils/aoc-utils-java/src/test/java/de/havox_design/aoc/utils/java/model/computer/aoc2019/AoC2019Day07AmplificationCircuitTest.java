...
public class AoC2019Day07AmplificationCircuitTest {
    @ParameterizedTest
    @MethodSource("getDataForTask1")
    void testTask1(String fileName, long expectation) {
        Assertions.assertEquals(expectation, AoC2019Day07AmplificationCircuit.processTask1(fileName));
    }
    ...
    void testTask2(String fileName, long expectation) {
        Assertions.assertEquals(expectation, AoC2019Day07AmplificationCircuit.processTask2(fileName));
    }
