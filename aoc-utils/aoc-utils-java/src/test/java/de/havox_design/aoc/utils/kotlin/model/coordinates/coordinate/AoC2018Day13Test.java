...
class AoC2018Day13Test {

    @ParameterizedTest
    @MethodSource("getDataForTask1")
    void testTask1(String fileName, String expectation) {
        Assertions.assertEquals(expectation, AoC2018Day13MineCartMadness.processTask1(fileName));
    }
    ...
    void testTask2(String fileName, String expectation) {
        Assertions.assertEquals(expectation, AoC2018Day13MineCartMadness.processTask2(fileName));
    }
