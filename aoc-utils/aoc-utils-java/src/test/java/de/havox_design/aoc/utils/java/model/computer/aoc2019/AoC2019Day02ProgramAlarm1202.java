...
public class AoC2019Day02ProgramAlarm1202 implements AoCFunctionality {
    private static final String VALUE_DELIMITER = ",";

    private final List<Long> input;

    public AoC2019Day02ProgramAlarm1202(String fileName) {
        input = Arrays
    ...
    public static long processTask1(String fileName) {
        AoC2019Day02ProgramAlarm1202 instance = new AoC2019Day02ProgramAlarm1202(fileName);
