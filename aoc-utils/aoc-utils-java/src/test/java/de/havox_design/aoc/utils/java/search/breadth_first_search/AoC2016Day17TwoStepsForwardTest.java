...
class AoC2016Day17TwoStepsForwardTest {

    @ParameterizedTest
    @MethodSource("getDataForPart1")
    void testPart1(String fileName, String expected) {
        Assertions.assertEquals(expected, AoC2016Day17TwoStepsForward.solvePart1(fileName));
    }
    ...
    void testPart2(String fileName, long expected) {
        Assertions.assertEquals(expected, AoC2016Day17TwoStepsForward.solvePart2(fileName));
    }
